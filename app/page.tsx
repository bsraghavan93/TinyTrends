        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-500">
              ...
              <span className="hidden sm:inline text-gray-700">|</span>
              <a href="https://www.instagram.com/pixelcraftstudio.web?igsh=NzlxNmt6eWE3cGtq" target="_blank" rel="noopener noreferrer" className="hidden sm:inline-flex items-center gap-1.5 hover:text-pink-400 transition-colors">
